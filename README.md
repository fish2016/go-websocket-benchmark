...
# 基于原项目(go-websocket-benchmark)[https://github.com/lesismal/go-websocket-benchmark]增加gnet框架的测试
## 编译命令
``````
go build -o "./output/bin/bench.client" "./mwsbench"

go build -o "./output/bin/gnet_gobwas.server" "./frameworks/gnet_gobwas"
``````
## 测试命令
``````
./script/client.sh -f fasthttp -c=400 -en=2000000 -b=1024 -rr=1
./script/client.sh -f gnet_gobwas -c=400 -en=2000000 -b=1024 -rr=1
``````

## 全量测试命令
``````
./script/benchmark.sh -c=400 -en=2000
``````

## 只生成测试报告 
./script/client.sh -r=true

./script/client.sh -r=true
20250212 16:48.07.579 pwd: /home/dev/code/go-websocket-benchmark
----------------------------------------------------------------------------------------------------
20250212 16:48.07.581 [Connections] Report

|    Framework     | TPS |   Min    |   Avg    |   Max    |   TP50   |   TP75   |   TP90   |   TP95   |   TP99   |   Used   | Total | Success | Failed | Concurrency |
|     ---          | --- |   ---    |   ---    |   ---    |   ---    |   ---    |   ---    |   ---    |   ---    |   ---    |  ---  |   ---   |  ---   |     ---     |
|   fasthttp       | 195 | 503.68ms | 506.60ms | 508.88ms | 506.66ms | 507.82ms | 508.42ms | 508.74ms | 508.88ms | 510.99ms |  100  |    0    |  100   |     100     |
|    gobwas        | 196 | 503.24ms | 506.41ms | 508.84ms | 506.28ms | 507.50ms | 508.02ms | 508.53ms | 508.84ms | 509.99ms |  100  |    0    |  100   |     100     |
|    gorilla       | 195 | 503.97ms | 507.62ms | 511.02ms | 507.72ms | 508.91ms | 510.08ms | 510.68ms | 511.02ms | 512.06ms |  100  |    0    |  100   |     100     |
|     gws          | 196 | 502.29ms | 505.22ms | 507.75ms | 505.08ms | 506.05ms | 506.80ms | 507.43ms | 507.75ms | 508.88ms |  100  |    0    |  100   |     100     |
|    gws_std       | 195 | 504.82ms | 507.66ms | 510.64ms | 507.74ms | 508.83ms | 509.82ms | 510.55ms | 510.64ms | 512.26ms |  100  |    0    |  100   |     100     |
|    hertz         | 195 | 503.33ms | 506.58ms | 509.82ms | 506.45ms | 507.92ms | 509.15ms | 509.47ms | 509.82ms | 510.86ms |  100  |    0    |  100   |     100     |
|   hertz_std      | 194 | 504.52ms | 510.70ms | 514.44ms | 511.11ms | 512.19ms | 513.17ms | 513.98ms | 514.44ms | 515.43ms |  100  |    0    |  100   |     100     |
|  nbio_blocking   | 195 | 503.65ms | 505.50ms | 508.41ms | 505.46ms | 506.22ms | 506.92ms | 508.23ms | 508.41ms | 510.59ms |  100  |    0    |  100   |     100     |
|   nbio_mixed     | 195 | 503.40ms | 507.27ms | 510.61ms | 507.44ms | 508.80ms | 509.82ms | 510.42ms | 510.61ms | 511.94ms |  100  |    0    |  100   |     100     |
| nbio_nonblocking | 194 | 505.86ms | 511.70ms | 514.32ms | 511.93ms | 513.10ms | 513.63ms | 514.04ms | 514.32ms | 515.38ms |  100  |    0    |  100   |     100     |
|   nbio_std       | 194 | 504.04ms | 507.78ms | 511.58ms | 508.23ms | 509.23ms | 509.98ms | 511.06ms | 511.58ms | 513.28ms |  100  |    0    |  100   |     100     |
|    nettyws       | 193 | 507.33ms | 511.74ms | 515.55ms | 512.01ms | 513.48ms | 514.40ms | 514.94ms | 515.55ms | 515.80ms |  100  |    0    |  100   |     100     |
|    nhooyr        | 195 | 505.10ms | 508.22ms | 511.39ms | 508.35ms | 509.73ms | 510.23ms | 510.51ms | 511.39ms | 512.76ms |  100  |    0    |  100   |     100     |
|    quickws       | 195 | 503.32ms | 506.96ms | 510.57ms | 506.93ms | 508.21ms | 509.05ms | 509.30ms | 510.57ms | 511.76ms |  100  |    0    |  100   |     100     |
|    greatws       | 195 | 502.84ms | 506.64ms | 509.58ms | 506.64ms | 507.90ms | 508.92ms | 509.36ms | 509.58ms | 510.39ms |  100  |    0    |  100   |     100     |
|  greatws_event   | 195 | 505.14ms | 508.76ms | 511.63ms | 508.98ms | 509.97ms | 510.73ms | 511.18ms | 511.63ms | 512.38ms |  100  |    0    |  100   |     100     |
|  gnet_gobwas     | 196 | 502.35ms | 505.11ms | 507.60ms | 505.08ms | 505.99ms | 506.59ms | 506.91ms | 507.60ms | 507.82ms |  100  |    0    |  100   |     100     |
----------------------------------------------------------------------------------------------------